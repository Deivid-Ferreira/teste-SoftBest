						...
						<div id="conteudo-contato">
							...
							<form id="targetForm" action="<?php echo $configUrl;?>contato/sendEmail.php" method="post">
								<div id="col-esq-fale">
									...
									<input class="input" type="text" style="width:520px;" required name="nome" value="" /></p>
											
									<br class="clear"/>		
											
									<p class="campos-padrao-float"><label class="label">Cidade<span class="obrigatorio"> * </span></label><br/>
									<input class="input" type="text" style="width:255px;" required name="cidade" value="" /></p>
																																
						3			<p class="campos-padrao-float campos-select" style="margin-right:0px;"><label class="label">Estado<span class="obrigatorio"> * </span></label><br/>
									...
									<input class="input" type="text" style="width:205px;" required name="celular" value="" onKeyDown="Mascara(this,novoTelefone);" onKeyPress="Mascara(this,novoTelefone);" onKeyUp="Mascara(this,novoTelefone);"/></p>			
																								
									<p class="campos-padrao"><label class="label">E-mail<span class="obrigatorio"> </span></label><br/>
									<input class="input" type="email" id="email" name="email" style="width:273px;" value="" /></p>									
								...
								<div id="col-dir-fale">
									<div id="filial-1"> 
										<p class="telefone" <?php if($telefone == ""){ ?> style=" display:none "  <?php } ?> ><a class="descricao" title="Clique para Chamar no WhatsApp!"><?php echo $telefone;?></a></p>
										<p class="celular"><a class="descricao" title="Clique para Chamar no WhatsApp!"  onClick="abrirAcesso();"><?php echo $celular;?></a></p>
										<br class="clear"/>
									
										<p class="endereco-1"><a class="descricao" target="_blank" title="Clique para fazer uma Rota!" href="<?php echo $rota;?>"><?php echo $endereco;?></a></p>
										<br class="clear"/>
										<div id="mapa">
											<?php echo $mapa;?>
										</div>
