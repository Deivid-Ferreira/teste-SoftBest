...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>site/depoimentos/ativacao/<?php echo $dadosNomePagamento['codDepoimento'] ?>/' title='Deseja <?php echo $statusPergunta ?> o depoimento <?php echo $dadosNomePagamento['nomeDepoimento'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
					...
					<div class="botao-consultar"><a title="Consultar Depoimentos" href="<?php echo $configUrl;?>site/depoimentos/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>site/depoimentos/alterar/<?php echo $url[6] ;?>/" method="post">
