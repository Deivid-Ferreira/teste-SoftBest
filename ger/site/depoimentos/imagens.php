...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>site/depoimentos/ativacao/<?php echo $dadosNomeDepoimento['codDepoimento'] ?>/' title='Deseja <?php echo $statusPergunta ?> o depoimento <?php echo $dadosNomeDepoimento['nomeDepoimento'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>site/depoimentos/alterar/<?php echo $dadosNomeDepoimento['codDepoimento'] ?>/' title='Deseja alterar o depoimento <?php echo $dadosNomeDepoimento['nomeDepoimento'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar-branco.gif" alt="icone" /></a></td>
					...
					<div class="botao-consultar"><a title="Consultar Depoimentos Capa" href="<?php echo $configUrl;?>site/depoimentos/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>site/depoimentos/imagens/<?php echo $url[6];?>/" enctype="multipart/form-data" method="post">
...
?>
 ...
 <?php
				...
				$regPorPag = 14;
				$area = "site/depoimentos/imagens/".$url[6];
