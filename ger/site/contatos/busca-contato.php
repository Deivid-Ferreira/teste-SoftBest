...
?>
								<tr class="tr">
									...
									<td class="botoes"><a href='<?php echo $configUrl; ?>site/contatos/alterar/<?php echo $dadosContatos['codContato'] ?>/' title='Deseja alterar o contato <?php echo $dadosContatos['nomeContato'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
