...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>site/equipe/ativacao/<?php echo $dadosNomePagamento['codEquipe'] ?>/' title='Deseja <?php echo $statusPergunta ?> o integrante da equipe <?php echo $dadosNomePagamento['nomeEquipe'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
					...
					<div class="botao-consultar"><a title="Consultar Equipe" href="<?php echo $configUrl;?>site/equipe/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
<?php
				if(isset($_POST['alterar'])){
					...
					$sql = "UPDATE equipe SET nomeEquipe = '".preparaNome($_POST['nome'])."', celularEquipe = '".$_POST['celular']."', subNomeEquipe = '".preparaNome($_POST['subNome'])."', descricaoEquipe = '".str_replace("'", "&#39;", $descricao)."', urlEquipe = '".$urlEquipe."' WHERE codEquipe = '".$url[6]."'";
					...
					$_SESSION['celular'] = $dadosEquipe['celularEquipe'];
				}
...
?>
						...
						<form action="<?php echo $configUrlGer; ?>site/equipe/alterar/<?php echo $url[6] ;?>/" method="post">
...
?>
							...
							<input id="nome" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> required class="campo" type="text" name="nome" style="width:320px;" value="<?php echo $_SESSION['nome']; ?>" /></p>

							<p class="bloco-campo-float"><label>Celular: <span class="obrigatorio"> </span></label>
							<input class="campo" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> id="celular" type="text" name="celular" style="width:235px;" value="<?php echo $_SESSION['celular']; ?>" onKeyDown="Mascara(this,novoTelefone);" onKeyPress="Mascara(this,novoTelefone);" onKeyUp="Mascara(this,novoTelefone);"/></p>
