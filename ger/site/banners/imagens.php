...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>site/banners/imagens/<?php echo $url[6];?>/" enctype="multipart/form-data" method="post">
							...
							<p class="bloco-campo"><label class="label" style="font-size:15px; line-height:20px; font-weight:normal;"><strong>Extensão:</strong> png,jpg ou jpeg<br/><strong>Tamanho Desktop:</strong> 1920 x 649 | <strong>Tamanho Mobile:</strong> 1000 x 1000</labeL>
...
?>       
								<div class="imagem" style="width:300px; height:200px; margin-right:30px;">
									<p style="width:300px; height:142px; display:table-cell; vertical-align:middle;"><img src="<?php echo $configUrl."f/banners/".$dadosImagem['codBanner'].'-'.$dadosImagem['codBannerImagem'].'-O.'.$dadosImagem['extBannerImagem'];?>" alt="Imagem Banner" style="max-width:300px; max-height:120px;"/><br/></p>
