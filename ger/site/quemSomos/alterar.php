...
<?php
				if(isset($_POST['alterar'])){
					...
					if($result == 1){
						...
						$erroData = "<p class='erro'>Problemas o alterar o Sobre!</p>";
					}
				}else{
...
?>
						...
						<form action="<?php echo $configUrlGer; ?>site/quemSomos/alterar/<?php echo $url[6] ;?>/" method="post">
							...
							<textarea class="campo" id="descricaoC" name="descricaoC" <?php echo $erroAtiva == "ok" ? "" : "";?> type="text" style="width:1042px; height:200px;" ><?php echo $_SESSION['descricaoC']; ?></textarea></p>
