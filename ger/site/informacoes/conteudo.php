...
<?php
				if(isset($_POST['alterar'])){
					...
					$_SESSION['email2'] = $dadosInformacao['email2Informacao'];
...
?>						
						...
						<form action="<?php echo $configUrlGer; ?>site/informacoes/" method="post">
							...
							<p class="bloco-campo"><label>E-mail 1: <span class="obrigatorio"> </span></label>
							<input id="email" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="email" style="width:497px;" value="<?php echo $_SESSION['email']; ?>" /></p>
							
							<p class="bloco-campo"><label>E-mail 2: <span class="obrigatorio"> </span></label>
							<input id="email2" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="email2" style="width:497px;" value="<?php echo $_SESSION['email2']; ?>" /></p>
