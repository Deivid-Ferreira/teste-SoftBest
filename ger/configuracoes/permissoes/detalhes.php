...
?>
					<div id="permicoes">
						...
						<form name="formPermissao" action="<?php echo $configUrl;?>configuracoes/permissoes/detalhes/<?php echo $url[6];?>/" method="post" >
							<div id="permissoes-atendimento" style="width:300px; height:350px;">
								<p class="area-permicao">Site:</p>
<?php		
				$numero = 1;
				
				$sqlAreasAtendimento = "SELECT * FROM areasAcesso WHERE codMenuAreaAcesso = 6 and statusAreaAcesso = 'T' ORDER BY codAreaAcesso ASC";
