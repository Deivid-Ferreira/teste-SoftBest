...
?>				
						...
						<form name="formUsuarioes" action="<?php echo $configUrlGer; ?>configuracoes/usuarios/alterar/<?php echo $url[6] ;?>/" method="post">
							...
							<input id="nome" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="nome" style="width:360px;" required value="<?php echo $_SESSION['nome']; ?>" /></p>
						
							<p class="bloco-campo-float"><label>Sobrenome: <span class="obrigatorio"> * </span></label>
							<input id="sobrenome" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="sobrenome" style="width:380px;" required value="<?php echo $_SESSION['sobrenome']; ?>" /></p>
