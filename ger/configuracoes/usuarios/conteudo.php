...
?>				
						...
						<form name="formUsuarioes" action="<?php echo $configUrlGer; ?>configuracoes/usuarios/" method="post" onSubmit="return valida_dados2(this)">
							...
							<input class="campo" type="text" id="nome" name="nome" style="width:360px;" required value="<?php echo $_SESSION['nome']; ?>" /></p>
						
							<p class="bloco-campo-float"><label>Sobrenome: <span class="obrigatorio"> * </span></label>
							<input class="campo" type="text" id="sobrenome" name="sobrenome" style="width:380px;" required value="<?php echo $_SESSION['sobrenome']; ?>" /></p>
...
<?php
				...
				$sqlConta = "SELECT nomeUsuario, codFilial FROM usuarios WHERE codUsuario != '' ".$filtraUsuario2;
				$resultConta = $conn->query($sqlConta);
				$dadosConta = $resultConta->fetch_assoc();
